...
sed -i "s/smtpd_tls_cert_file=\/etc\/ssl\/certs\/ssl-cert-snakeoil\.pem//" /etc/postfix-inbound/main.cf
sed -i "s/smtpd_tls_key_file=\/etc\/ssl\/private\/ssl-cert-snakeoil\.key//" /etc/postfix-inbound/main.cf
sed -i "s/smtp_tls_cert_file=\/etc\/ssl\/certs\/ssl-cert-snakeoil\.pem//" /etc/postfix-inbound/main.cf
sed -i "s/smtp_tls_key_file=\/etc\/ssl\/private\/ssl-cert-snakeoil\.key//" /etc/postfix-inbound/main.cf

sed -i "s/#xsmtpd_tls_cert_file/smtpd_tls_cert_file/" /etc/postfix-inbound/main.cf
sed -i "s/#xsmtpd_tls_key_file/smtpd_tls_key_file/" /etc/postfix-inbound/main.cf
sed -i "s/#xsmtp_tls_cert_file/smtp_tls_cert_file/" /etc/postfix-inbound/main.cf
sed -i "s/#xsmtp_tls_key_file/smtp_tls_key_file/" /etc/postfix-inbound/main.cf
